...
I think axioss is kind of like a way to make code cleaner and its sort of like a higer order function as it is doing what fetch does under the hood and axios automatically transforms the data into a javascript object as soon and the return comes back. I have never used axios that much in code I have written but it seems like a commodity.It seems like it can make code a bit cleaner but maybe developers should learn how to do both ways so whatever job you get you can use which ever method that your company is utlizing.
Fetch is bare-bones You have to manually check if the response is okay and manually convert it to JSON. axios is opinionated: It assumes if you're making a web request, you probably want JSON back and you probably want an error thrown if the status code is 404 or 500.